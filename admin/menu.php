<nav class="giri-menus col-xs-4 col-sm-2 navbar navbar-inverse navbar-fixed-top">
			<div class="navbar-header">
                <div class="bg-header">
                </div>
                <div class="admin-info-container">
                    <div class="prof-pic-conteiner">
                        <img src="../images/giri.png">
                    </div>
                    <p class="greet">Welcome, Master!</p>
                    <a href="index.php" class="navbar-brand">GIRI ADMIN</a>
                </div>
			</div>
